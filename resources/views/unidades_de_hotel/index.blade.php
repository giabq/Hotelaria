        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-success" href="{{ route('unidades_de_hotel.create') }}"> Adicionar Unidade de
                        Hotel</a>
                </div>
            </div>
        </div>
                    ...
                    <td>
                        <form action="{{ route('unidades_de_hotel.destroy', $unidade->id_hotel) }}" method="POST">
                            <a class="btn btn-info"
                                href="{{ route('unidades_de_hotel.show', $unidade->id_hotel) }}">Mostrar</a>
                            <a class="btn btn-primary"
                                href="{{ route('unidades_de_hotel.edit', $unidade->id_hotel) }}">Editar</a>
                            @csrf
                            @method('DELETE')
